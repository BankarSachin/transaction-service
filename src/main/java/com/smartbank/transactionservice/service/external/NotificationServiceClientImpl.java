	...
	public CompletableFuture<NotificationResponse> notifyTransfer(Map<String, String> headers, String debitAccountNumber,
		...
		try {
			...
			if (notificationResponse.hasBody()) {
				...
				notificationFuture.completeExceptionally(new TxnException(ExceptionCode.TXNS_NTFS_SERVICE_EMPTY_RESPONSE));
			}
			...
			notificationFuture.completeExceptionally(new TxnException(ExceptionCode.TXNS_NTFS_SERVICE_EXCEPTION,errorInfo.getCode(), errorInfo.getCauses().get(0)));
